...
# run: ./flow-antigravity-proposal-harness.sh --task_id 1 --task_name "walk-through-antigravity-proposal-harness" --query "Current realtime weather in Hamburg Germany please. Put your findings in ./sandbox_output/findings.json. Warning: it must be a **SIMPLE** json structure."
